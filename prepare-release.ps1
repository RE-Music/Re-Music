...
# Generate update.json (Double-Encoded Base64 for Tauri v2)
$sigText = Get-Content $msiSig.FullName -Raw
$sigBase64 = [Convert]::ToBase64String([System.Text.Encoding]::UTF8.GetBytes($sigText))
